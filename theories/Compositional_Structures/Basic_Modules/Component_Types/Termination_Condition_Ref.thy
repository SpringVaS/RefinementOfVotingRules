...
theory Termination_Condition_Ref
  imports Verified_Voting_Rule_Construction.Result
...
type_synonym 'a Termination_Condition_Ref = "'a Result \<Rightarrow> bool nres"
